...
import { addSubject } from "../../../services/subjectSlice";
import { useDispatch, useSelector } from "react-redux";

const AddSubject = ({ showModal, setShowModal }) => {
  ...
  const onSubmit = async (data) => {
    dispatch(addSubject({ toast, data }))
      .unwrap()
      .then(() => {
        reset();
        setShowModal(false);
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-md bg-white rounded-xl shadow-lg p-6">
        <h1 className="text-lg font-bold text-gray-800">Add New Subject</h1>
        <button
          type="button"
